...
def form3A(url):
    ...
    Box17 = soup.find('table', id='grdCap_Dir_Sh')
    Box17all = []
    ...
    Box18 = soup.find('table', id='grdDer_Dir')
    Box18all = []
...
m=0
with open('Form3A.csv', 'w', newline='', encoding='utf-8') as csvfile:
    linewriter = csv.writer(csvfile, delimiter='@')
    for row in form3Adata:
        m += 1
